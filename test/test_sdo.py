...
class TestSDOVariablesSync(BaseTests.TestSDOVariables):
    use_async = False


class TestSDOVariablesAsync(BaseTests.TestSDOVariables):
    use_async = True


class TestSDOSync(BaseTests.TestSDO):
    use_async = False


class TestSDOAsync(BaseTests.TestSDO):
    use_async = True


class TestSDOClientDatatypesSync(BaseTests.TestSDOClientDatatypes):
    use_async = False


class TestSDOClientDatatypesAsync(BaseTests.TestSDOClientDatatypes):
    use_async = True
