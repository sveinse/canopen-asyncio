...
class TestNmtMasterSync(BaseTests.TestNmtMaster):
    use_async = False


class TestNmtMasterAsync(BaseTests.TestNmtMaster):
    use_async = True


class TestNmtSlaveSync(BaseTests.TestNmtSlave):
    use_async = False


class TestNmtSlaveAsync(BaseTests.TestNmtSlave):
    use_async = True
